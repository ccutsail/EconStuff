...
# log of year 1993 - log of year 1973
# again in 2013
...
#### divide county income by average county income in that year
...
# this is wrong! should be the cross-period growth rates averaged.
cpCp <- cp_ft %>% 
...
# Compute mean period two growth rate
#### period by period growth rate -- wrong!!
periodIncome <- cp_ft %>% 
