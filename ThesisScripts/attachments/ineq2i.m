function [out] = ineq2i(x,ti,paramvec)
...
out = [1/c11 - bp*bt*(1-tb)*R/c11;...
       1/c11 - bp*bt*(1-ti)*w*D1*etae*(e1)^(etae-1)*h1^etah/((1-te)*c11);...
       1/c11 - bp/c01;...
       1/c21 - bp*(1-tb)/c11;...
       
       % Type One budget constraints
       (1-ti)*w*h1+(1-tb)*b1-c11-c01-s1-(1+te)*e1;...
       R*s1-b1-c21;...
       h1^(1-etah) - D1*e1^etae; ...
       
       %Type Two FOCs
       1/c12 - bp*bt*(1-tb)*R/c12;...
       1/c12 - bp*bt*(1-ti)*w*D2*etae*(e2)^(etae-1)*h2^etah/((1+te)*c12);...
       1/c12 - bp/c02;...
       1/c22 - bp*(1-tb)/c12;...
      
       % Type Two Constraints
       (1-ti)*w*h2+(1-tb)*b2-c12-c02-s2-(1+te)*e2;...
       R*s2-b2-c22;...
       ...
       tb*(b1*n1+b2*n2)+ti*w*(h1*n1+h2*n2)+te*(e1*n1+e2*n2)];
